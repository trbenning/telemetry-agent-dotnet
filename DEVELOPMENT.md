...
1. Open the solution using the `iot-stream-analytics.sln` file.
...
We also provide a
[Java version](https://github.com/Azure/iot-stream-analytics-java)
...
[iot-stream-analytics.sln.DotSettings](iot-stream-analytics.sln.DotSettings)
