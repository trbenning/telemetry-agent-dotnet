...
namespace Microsoft.Azure.IoTSolutions.IoTStreamAnalytics.StreamingAgent
{
    public class DependencyResolution
    {
        ...
        private static void SetupCustomRules(ContainerBuilder builder)
        {
            ...
            var logger = new Logger(Uptime.ProcessId, LogLevel.Info);
            ...
            // Reminder: EventProcessor and DocumentWriter must not be registered as singleton!
            builder.RegisterType<Agent>().As<IAgent>().SingleInstance();
            builder.RegisterType<EventProcessorFactory>().As<IEventProcessorFactory>().SingleInstance();
            ...
            builder.RegisterType<ThroughputCounter>().As<IThroughputCounter>().SingleInstance();
            builder.RegisterType<Alarms>().As<IAlarms>().SingleInstance();
            builder.RegisterType<DeviceGroups>().As<IDeviceGroups>().SingleInstance();
            builder.RegisterType<DeviceMessageParser>().As<IDeviceMessageParser>().SingleInstance();
            builder.RegisterType<Services.Devices>().As<IDevices>().SingleInstance();
            builder.RegisterType<Messages>().As<IMessages>().SingleInstance();
            builder.RegisterType<Rules>().As<IRules>().SingleInstance();
            builder.RegisterType<RulesEvaluation>().As<IRulesEvaluation>().SingleInstance();
        }
