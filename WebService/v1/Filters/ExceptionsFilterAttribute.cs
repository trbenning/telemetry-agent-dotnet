...
using Microsoft.Azure.IoTSolutions.IoTStreamAnalytics.WebService.v1.Exceptions;
using Newtonsoft.Json;

namespace Microsoft.Azure.IoTSolutions.IoTStreamAnalytics.WebService.v1.Filters
{
    /// <summary>
