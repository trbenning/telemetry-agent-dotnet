...
SET DOCKER_IMAGE="azureiotpcs/iot-stream-analytics-dotnet"
...
rmdir /s /q StreamingAgent\bin\Docker

mkdir out\docker\webservice
mkdir out\docker\streamingagent

dotnet publish WebService      --configuration %CONFIGURATION% --output bin\Docker
dotnet publish StreamingAgent  --configuration %CONFIGURATION% --output bin\Docker

xcopy /s WebService\bin\Docker\*       out\docker\webservice\
xcopy /s StreamingAgent\bin\Docker\*   out\docker\streamingagent\
